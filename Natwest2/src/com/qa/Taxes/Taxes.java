...
//
//	Method 1 - which takes a salary and works out 
//	the percentage by which the salary will be taxed.
//
//	Method 2 - which works out the exact amount that 
//	the user will be taxed using a similar process to 
//	that in the first method. That amount should be 
//	returned and output to the console.
//
...
//	utilizes the first method to return the correct result.
	...
	if (salary >= 0 && salary <= 14999) {
		...
		}else if (salary>=3000 && salary<=44999) {  
		    tax =20;
		    System.out.println(tax + "%");
